...
```
replace the entire file by: ( I know this is a bad practice but one has to deal with depritiated stuff getting looped the hard way ) ( or just comment the run  , it will just loop....) uncomment it after installing
